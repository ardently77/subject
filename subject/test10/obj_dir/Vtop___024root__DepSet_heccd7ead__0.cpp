...
#endif
                VL_FATAL_MT("top.v", 62, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("top.v", 62, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("top.v", 62, "", "NBA region did not converge.");
            }
